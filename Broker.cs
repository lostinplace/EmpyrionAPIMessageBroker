...
namespace EmpyrionMessageBroker
{
    ...
    public static partial class Broker
    {
        ...
        public static void HandleGameEvent(CmdId eventId, ushort seqNr, object data)
        {
            ...
            if (EmpyrionAPIContractManager.UnsolicitedEvents.ContainsKey(eventId)) handleUnsolicitedEvent(apiEvent);
            ...
            var firstApplicableRequest = outstandingRequestList.FirstOrDefault(x => x.call.ExpectedResponseEvent.responseCmdId == eventId || eventId == CmdId.Event_Error);
